...
dotenv.config();
export const ESPN_EVENT_API_URL = 'http://sports.core.api.espn.com/v2/sports/football/leagues/nfl/events';
export const ESPN_TEAM_API_URL = 'https://site.api.espn.com/apis/site/v2/sports/football/nfl/teams';
